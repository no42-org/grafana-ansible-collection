...
| `grafana_install_retries` | 3 | Retries for the package installation, which fetches repository metadata over the network. Set to 0 to install exactly once. |
| `grafana_install_retry_delay` | 10 | Seconds between those retries |
