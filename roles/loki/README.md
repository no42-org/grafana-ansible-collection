...
| `loki_ui` | The **experimental** `ui` block configures the loki UI. 📚 configuration [Documentation](https://grafana.com/docs/loki/latest/configure/#supported-contents-and-default-values-of-lokiyaml)
| `loki_query_engine` | The **experimental** `query_engine` block configures the next generation query engine for supported queries. 📚 configuration [Documentation](https://grafana.com/docs/loki/latest/configure/#supported-contents-and-default-values-of-lokiyaml)
...
| `loki_pattern_ingester` | The `pattern_ingester` block configures the pattern ingesters, which are used to discover log patterns. 📚 configuration [Documentation](https://grafana.com/docs/loki/latest/configure/#supported-contents-and-default-values-of-lokiyaml)
